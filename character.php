<?php 
    ...
    if (isset($_GET['search'])){
      $result3 = mysqli_query($db, "SELECT * FROM karakter k, house h WHERE name_char LIKE '%".
          $_GET['search']."%'");
     }
    ...
    <div class="products-area-wrapper tableView">
      ...
      <div class="products-row">
        ...
        <div class="cell=label" >
          <a class="fa-solid fa-square-pen" class="edit" href="edit_house.php?id_char=<?=$row['id_char']?>">Edit</a>
        </div>
        <span></span>
        <div class="cell=label" >
          <a class="fa-solid fa-trash" class="hapus" href="hapus_house.php?id_char=<?=$row['id_char']?>">Hapus</a>
        </div>
      </div>
      <?php
            //     $i++;
