...
if(!isset($_SESSION['user'])){
    ...
    if (isset($_GET['search'])){
      $result2 = mysqli_query($db, "SELECT * FROM house WHERE name_house LIKE '%".
          $_GET['search']."%'");
    }else{
...
<div class="app-container">
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">House Database</h1>
    ...
    <div class="products-area-wrapper tableView">
      ...
      <div class="products-row">
        <button class="cell-more-button">
          ...
          <div class="product-cell image">
            <img src="pic_house/<?=$row['pict_house']?>" alt="" width="100px">
        ...
        <ul class="footer-me">
          <ul class="footer-me1">
            <li><a class="fa-solid fa-square-pen" class="edit" href="edit_house.php?id_house=<?=$row['id_house']?>"></a><a class="fa-solid fa-trash" class="hapus" href="hapus_house.php?id_house=<?=$row['id_house']?>"></a></li>
          </ul>
        </ul>
