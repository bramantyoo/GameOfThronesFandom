   ...
   if(isset($_GET['id_house'])){
    ...
    $result2 = mysqli_query($db, 
      "SELECT * FROM house WHERE id_house='$id_house'");
   ...
   if(isset($_POST['submit'])){
       ...
       loc_house='$loc_house',
       region_house='$region_house',
       words_house='$words_house',
       pict_house='$pict_house_baru'
...
<head>
    ...
    <title>GOT | Form Edit House | Admin</title>
