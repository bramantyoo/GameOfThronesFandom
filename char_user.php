  ...
  <div class="products-area-wrapper gridView">
    ...
    <div class="products-row">
      ...
      <div class="product-cell image">
        ...
        <h3><span><?=$row['name_char']?></span></h3>
      </div>
      <div class="product-cell category"><span class="cell-label">
          <h4>ID:</h4>
        </span><?=$row['id_char']?></div>
      <div class="product-cell sales"><span class="cell-label">
          <h4>Nama House:</h4>
        </span><?=$row['name_house']?></div>
      <div class="product-cell stock"><span class="cell-label">
          <h4>Title:</h4><?=$row['title_char']?></div>
      <div class="product-cell price"><span class="cell-label">
          <h4>Caption:</h4><?=$row['caption_char']?></div>
    </div>
    <?php
          $i++; 
          }
